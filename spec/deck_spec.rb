  ...
  describe '#cards-in-category' do
    ...
    context 'when category is not present' do
      it 'returns empty array' do
        ...
        second_card = Card.new('The Viking spacecraft sent back to Earth photographs and reports about the surface of which planet?', 'Mars', :Fantasy)
        third_card = Card.new('Describe in words the exact direction that is 697.5° clockwise from due north?', 'North north west', :Fantasy)
