...
def start()
     ...
     def display_welcome
          text = %Q(
          Welcome! Your're playing with 8 cards.
          --------------------------------------
          )
          puts text
     end
     ...
     def display_card
          puts "This is card number #{@index} out of 8."
     ...
     def display_game_over
          ...
          ****** Game over! ******
          You had #{@round.number_correct} correct guesses out of 8 for a total score of #{@round.percent_correct}%.
