...
puts "This is card number #{(round.turns.count + 1)} out of #{round.total_cards}."
...
puts "******* GAME OVER! *******"
puts "You had #{round.number_correct} correct guesses out of #{round.total_cards} for a total score of #{round.percent_correct}%."
