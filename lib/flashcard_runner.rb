...
def start
  ...
  puts "Staff -#{round.percent_correct_by_category(:Staff).to_i}% correct" #not outputting correctly
  puts "Turing -#{round.percent_correct_by_category(:Turing).to_i}% correct"#not outputting correctly
end
start
